...
function Sidebar() {
  return (
    <>
        ...
        <aside className="sidebar-mobile glass" id="sidebarMobile">
            <button className="sidebar-mobile__close glass-card" id="closeSidebar">
            ...
            <div className="sidebar__avatar-wrap">
                <img src="images/profile.jpg" alt="Profile" className="sidebar__avatar" />
            </div>
            <div>
                <h1 className="sidebar__name">Kaelen Voss</h1>
                <p className="sidebar__title">UI/UX Designer & Developer</p>
            </div>
            ...
            <div className="sidebar__info">
                ...
                <div className="sidebar__info-row">
                    ...
                    <span className="sidebar__info-value">San Francisco, CA</span>
                </div>
                <div className="sidebar__info-row">
                    <span className="sidebar__info-label">Experience</span>
                    <span className="sidebar__info-value">8+ Years</span>
                </div>
            </div>
